...
import io.element.android.features.messages.impl.timeline.model.event.PdfSearchResultViewModel
...
@Composable
fun TimelineItemPdfSearchResultView(
    roomId: String?,
    eventId: String?,
    content: TimelineItemEmptyMessageContent,
    modifier: Modifier = Modifier,
    onLinkClick: (String) -> Unit,
    viewModel: PdfSearchResultViewModel = viewModel(),
